...
const FormData = require('form-data'); // Make sure this dependency is installed
...
app.post('/api/tts', apiLimiter, async (req, res) => {
    ...
    try {
        ...
        const response = await fetch('https://ttsmp3.com/makemp3.php', {
            ...
            body: formData,
            // -------------------------------------------------------------------
            // FIX: Merge the headers generated by the FormData instance.
            // This includes the crucial 'Content-Type: multipart/form-data; boundary=...' header.
            // -------------------------------------------------------------------
            headers: {
                ...formData.getHeaders(), 
